  ...
  return (
    <div className="relative mx-auto flex max-w-7xl flex-col items-center justify-center  bg-[#0d0d0d] ">
      ...
      <div className="absolute inset-x-0 bottom-0 h-px w-full bg-neutral-200/80 dark:bg-neutral-800/80">
        <div className="absolute mx-auto h-px w-full bg-gradient-to-r from-transparent via-yellow-500 to-transparent" />
      </div>
      
      <div className="px-4 py-10 md:py-20" id="home" >
        ...
        >
          Seamlessly create, customize, and deploy tokens on Solana in just minutes—no code required.
        </motion.p>
        <motion.div
          initial={{
            opacity: 0,
